...
import apiAvatar1 from '@/assets/apiImage1.png'
import apiAvatar2 from '@/assets/apiImage2.png'
import apiAvatar3 from '@/assets/apiImage3.png'
import apiAvatar4 from '@/assets/apiImage4.png'
import apiAvatar5 from '@/assets/apiImage5.png'
import apiAvatar6 from '@/assets/apiImage6.png'
import apiAvatar7 from '@/assets/apiImage7.png'
import apiAvatar8 from '@/assets/apiImage8.png'
import apiAvatar9 from '@/assets/apiImage9.png'
import apiAvatar10 from '@/assets/apiImage10.png'
...
const PublishApi = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto p-6">
            ...
            <div className="mb-8">
                <h1 className="text-3xl font-bold text-gray-800 ">Publish New API</h1>
